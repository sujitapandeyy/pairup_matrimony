...
interface ProfileViewProps {
  profile: Profile;
  onEditClick: () => void;
  showLookingFor?: boolean; // default true
  showOnlyLookingFor?: boolean; // default false
}

export default function ProfileView({ profile, onEditClick, showLookingFor = true, showOnlyLookingFor = false }: ProfileViewProps) {
  return (
    <div className="space-y-8">
      ...
      {(showLookingFor || showOnlyLookingFor) && (
        <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
